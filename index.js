...
const traditionalAnimalsColors = ['cow', 'sheep','pig'];
const [blackAndWhite, black, pink]= traditionalAnimalsColors
...
const colorInit = ['red', 'orange', 'yellow', 'green', 'blue', 'violet'] 
const [r, o, y, g, b, v] = colorInit
